...
| `craft`         | `recipe` | крафт (`brick`/`medkit`), ингредиенты списываются, иначе игнор |
...
| `state`        | `players[]`, `enemies[]`, `projectiles[]`     | 20 раз/с, broadcast всем (игроки несут `level/xp/xpNext/points/upgrades`) |
...
# крафт (v2):         кирпич = 2 камня | 3 носков; аптечка = 2 сыра + курага
# еда:                аптечка +60, сыр +12, курага +8 (E — лучшая); стройка F+ЛКМ — стена 50HP в радиусе 130
